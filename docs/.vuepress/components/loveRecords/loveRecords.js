...
let loveRecords = [
...

    {
        ...
        第二天，出门前，还去理发店找tony老师打理了一下，两个人感觉都是甜美风了。我们先去西湖边的银泰商圈逛吃，那人流量是真的多。本来准备去外婆家就餐的，奈何排队太长长，找了另一家人也超多的杭州特色餐厅弄堂里就餐。餐后绕着西湖继续逛，然而我的兴致才方兴未艾，莲莲的脚就受不了了，改为观光车游行。之后直奔浙大紫金港校区，应阿莲要求去走访我和初恋遍历过的地方……奈何校园太大，带她横穿校园，走走停停也就快到饭点了。想找记忆中的奶酸菜鱼无果，退而求其次找到了飚锅串串，很合我与阿莲的口味。今天这一天下来，咋俩已甚是疲惫了。
        
        第三天，将阿莲又接回了家里，在家里一起做个午饭，唠唠嗑温存一下。下午还抽空出去又唱了歌KTV。说来也乌龙，竟然差点在前台和服务券吵了起来。莲莲霸气。坚决捍卫自己的权利。
        
        嫦娥奔月，你（wo）奔向我(ni)。辛苦阿莲的舟车劳顿，咋俩有一个完整的中秋三天相聚时光。爱你么么哒！
        `,
        pics: [
...

    {
        ...
        desc: `
        为了庆祝咋俩的半周年纪念日，策划了一次大一点的周末游。为了省事，选择了惠州的海滨温泉抱团游。
        ...
        这是我的第一次抱团游，总的体验来说还不错，省事，性价比也还蛮高的。温泉有机会还可以再泡泡。对于我们这些社畜来说，真是不错的恢复能量的活动。
        晚上回家在一家情侣餐厅就餐比个心。
        `,
        pics: [
            "2019-12-07-渔船出海.jpg",
...

    {
        ...
        猫咪们似乎更愿意和莲莲互动，用一只逗猫棒惹得人家原地起飞。当然大部分还是荣辱不惊，慵懒佛系，需要我们好生服侍。以后有了自己的房子或回了重庆，咋俩也要养个小主子。
        `,
        pics: [
            "2019-12-25-猫咖钓猫.jpg",
            "2019-12-25-猫咖撸猫.jpg",
...

    {
        ...
        title: '盛大惊喜——我的生日',
        desc: `
        周六醒来，迷迷糊糊听到外面有声音，阿莲说她今早要洗头，也就没多想。可待回笼觉之后，走出卧室一看。好家伙，家里成为庆典现场了。满地的气球难以落脚，墙上的七喜哥哥happybirthday甚是喜庆。这是为我一个人精心准备的生日庆典，我这一辈子都没有收到过这么大的惊喜，重来没有人为了的生日准备得这么隆重。对者阿莲就是一阵搂搂抱抱，卿卿我我以平复心情。
...

    {
        ...
        除了插画集，莲莲又还偷偷给我走了星空投影器，配上星空风格的床头背景布。关上灯，躺在床上，犹如游离在太空之间。思绪缥缈，魂牵梦绕。
        `,
        pics: [
...

    {
        ...
        title: '医院急诊陪伴照顾',
        desc: `
        也许是周末的自制小火锅没处理干净吧，今天阿莲直接来了个急性肠胃炎。我也是遭受过这个苦的。莲莲在腹泻的摧残下，整个人都完全瘫了。本想熬到第二天再去医院，但莲莲深夜一点钟了还是又拉又通。便急忙拉到医院急诊去就医。
...

    {
        ...
        当我老了，走不动了，咋俩，把这回忆录翻开，幸福的感觉充溢全身。
...

    {
        ...
        国庆第三天，约到了钟典，又来到泽胜广场边逛边喝边闲聊。也通过他这一个窗口了解重庆的市场行情，以后回归重庆还有很多需要彼此帮扶的呢。中午一起吃的串串火锅，毕竟阿莲可是心心念念了好久的重庆火锅。之后也和钟典的女朋友打了个照面，踩雷一起观影了《姜子牙》。晚上回老家去看外公和姨吗们，又是吃的火锅，双重暴击。 ps.重庆乡镇的消费是真的低，一众9人才吃了不到400元。
