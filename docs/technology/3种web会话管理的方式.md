...
<font color=gray>注：该部分内容转载至网络。</font>  
作者：流云诸葛  
出处：[http://www.cnblogs.com/lyzg/](http://www.cnblogs.com/lyzg/)
...
![服务器session的交互模式](/img/technology/3种web会话管理的方式——服务器session的交互模式.png)
...
![cookie-based的交互逻辑](/img/technology/3种web会话管理的方式——cookie-based的交互逻辑.png)
...
[http://www.cnblogs.com/fish-li/archive/2012/04/15/2450571.html](http://www.cnblogs.com/fish-li/archive/2012/04/15/2450571.html)
...
![token-based交互逻辑](/img/technology/3种web会话管理的方式——token-based交互逻辑.png)
...
![JWT标准](/img/technology/3种web会话管理的方式——JWT标准.png)
